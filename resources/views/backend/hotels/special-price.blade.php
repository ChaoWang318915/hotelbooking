        ...
        <div class="content content-rest">
          ...
          <div class="restaurants-tabs">
            <ul>
              ...
              <li  class="active"><a href="{{url('/special-price',$hid)}}">Special Price</a></li>
            </ul>
          </div>

          <div class="details-form">
            <h3 class="form-name">Check-In / Check-Out</h3>
            <form action="{{route('special-price-update',$hid)}}" method="post" id="special-form">
              @csrf
              <div class="field">
          ...
          <div class="details-form" style="max-width: 80%;">
            <h3 class="form-name">Payments Texts</h3>
              ...
              <div class="field">
                ...
                <textarea id="lbl-017" rows="10" name="cancellation_policy">{{old('cancellation_policy', isset($rp) ? $rp->cancellation_policy : '') }}</textarea>
              </div>
