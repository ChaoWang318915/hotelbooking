...
class CreateBookingTextSpecialPricesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('booking_text_special_prices', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('booking_text_special_prices');
    }
}
