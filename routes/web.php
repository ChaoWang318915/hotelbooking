...
Route::get('/account',function()
{
   return view('account/guest-inquiry');
});

Route::get('/account',function()
{
   return view('account/guest-booking');
});

Route::get('/account',function()
{
   return view('account/member-inquiry');
});

Route::get('/account',function()
{
   return view('account/member-booking');
});
...
{
  return view('/templates/legal/impressum');
});

Route::get('/agb',function()
{
  return view('/templates/legal/agb');
});

Route::get('/datenschutz',function()
{
  return view('/templates/legal/datenschutz');
});
...
{
  return view('/templates/help/kontakt');
});

Route::get('/faq',function()
{
  return view('/templates/help/faq');
});


Route::get('/faq/hotels',function()
{
  return view('/templates/help/hotels');
});

Route::get('/faq/hotel-transfers',function()
{
  return view('/templates/help/hotel-transfers');
});


Route::get('/faq/fluege',function()
{
  return view('/templates/help/fluege');
});


Route::get('/faq/buchungen',function()
{
  return view('/templates/help/buchungen');
});


Route::get('/faq/zahlungen',function()
{
  return view('/templates/help/zahlungen');
});


Route::get('/faq/stornierungen',function()
{
  return view('/templates/help/stornierungen');
});



//Our Info pages
Route::get('/informationen',function()
{
  return view('/templates/info/informationen');
});

Route::get('/informationen/fakten',function()
{
  return view('/templates/info/facts');
});

Route::get('/informationen/einreisebestimmungen-visa',function()
{
  return view('/templates/info/einreise');
});

Route::get('/informationen/heiraten-auf-den-malediven',function()
{
  return view('/templates/info/heiraten-auf-den-malediven');
});

Route::get('/informationen/mein-zimmer-im-paradies',function()
{
  return view('/templates/info/mein-zimmer-im-paradies');
});

Route::get('/informationen/zusatzkosten',function()
{
  return view('/templates/info/zusatzkosten');
});

Route::get('/informationen/gesundheit',function()
{
  return view('/templates/info/gesundheit');
});

Route::get('/informationen/mit-kinder-auf-die-malediven',function()
{
  return view('/templates/info/kids');
});

Route::get('/informationen/hotels-der-malediven',function()
{
  return view('/templates/info/hotels-der-malediven');
});

Route::get('/informationen/all-inklusive',function()
{
  return view('/templates/info/all-inklusive');
});

Route::get('/informationen/andere-kulturen-andere-sitten',function()
{
  return view('/templates/info/andere-kulturen-andere-sitten');
});

Route::get('/informationen/einmal-malediven-immer-malediven',function()
{
  return view('/templates/info/einmal-malediven-immer-malediven');
});

Route::get('/informationen/hotel-transfers/geld-sparen-beim-flug',function()
{
  return view('/templates/info/geld-sparen-beim-flug');
});

Route::get('/informationen/altersregelungen',function()
{
  return view('/templates/info/altersregelungen');
});

Route::get('/informationen/condor',function()
{
  return view('/templates/info/condor');
});


Route::get('/informationen/wetter',function()
{
  return view('/templates/info/wetter');
});

Route::get('/informationen/notizen',function()
{
  return view('/templates/info/notizen');
});
...
// Info Pages with Transfers
Route::get('/informationen/hotel-transfers',function()
{
  return view('/templates/transfer/hotel-transfers');
});

Route::get('/informationen/hotel-transfers/wasserflugzeug',function()
{
  return view('/templates/transfer/wasserflugzeug');
});

Route::get('/informationen/hotel-transfers/schnellboot',function()
{
  return view('/templates/transfer/schnellboot');
});

Route::get('/informationen/hotel-transfers/inlandsflug',function()
{
  return view('/templates/transfer/inlandsflug');
});

Route::get('/informationen/hotel-transfers/probleme',function()
{
  return view('/templates/transfer/probleme-beim-hoteltransfer');
});
...
{
  return view('/templates/news/newsletter');
});


//Our Island Pages

Route::get('/informationen/inseln',function()
{
  return view('/templates/info/inseln');
});


Route::get('/atolle/raa/agolhitheemu',function()
{
  return view('/templates/inseln/agolhitheemu');
});

//Our atoll pages

Route::get('/atolle/haa-alifu',function()
{
  return view('/templates/atolle/haa-alifu');
});


Route::get('/atolle/vaavu',function()
{
  return view('/templates/atolle/vaavu');
});

Route::get('/atolle/thaa',function()
{
  return view('/templates/atolle/thaa');
});

Route::get('/atolle/shaviyani',function()
{
  return view('/templates/atolle/shaviyani');
});

Route::get('/atolle/seenu',function()
{
  return view('/templates/atolle/seenu');
});

Route::get('/atolle/raa',function()
{
  return view('/templates/atolle/raa');
});

Route::get('/atolle/noonu',function()
{
  return view('/templates/atolle/noonu');
});

Route::get('/atolle/meemu',function()
{
  return view('/templates/atolle/meemu');
});

Route::get('/atolle/male',function()
{
  return view('/templates/atolle/male');
});

Route::get('/atolle/lhaviyani',function()
{
  return view('/templates/atolle/lhaviyani');
});

Route::get('/atolle/laamu',function()
{
  return view('/templates/atolle/laamu');
});

Route::get('/atolle/kaafu',function()
{
  return view('/templates/atolle/kaafu');
});

Route::get('/atolle/gnaviyani',function()
{
  return view('/templates/atolle/gnaviyani');
});

Route::get('/atolle/gaafu-dhaalu',function()
{
  return view('/templates/atolle/gaafu-dhaalu');
});

Route::get('/atolle/gaafu-alifu',function()
{
  return view('/templates/atolle/gaafu-alifu');
});

Route::get('/atolle/haa-dhaalu',function()
{
  return view('/templates/atolle/haa-dhaalu');
});

Route::get('/atolle/faafu',function()
{
  return view('/templates/atolle/faafu');
});

Route::get('/atolle/dhaalu',function()
{
  return view('/templates/atolle/dhaalu');
});

Route::get('/atolle/baa',function()
{
  return view('/templates/atolle/baa');
});

Route::get('/atolle/alifu-dhaalu',function()
{
  return view('/templates/atolle/alifu-dhaalu');
});

Route::get('/atolle/alifu-alifu',function()
{
  return view('/templates/atolle/alifu-alifu');
});
...
Route::get('/’,‘Admin\likeunlikeController@likeunlike')->name('template.help.faq');
...
Route::post('/hotel-search-autocomplete','HotelpageController@hotel_search_autocomplete')->name('hotel-search-autocomplete');
Route::get('/autocomplete','HotelpageController@autocomplete')->name('autocomplete');
...
Route::get('/islands/{id}','IslandController@island_view')->name('islands-view');
